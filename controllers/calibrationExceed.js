...
const clearDataFromS3 = async (key) => {
    ...
    try {
        ...
        console.log(`Data for key ${key} cleared successfully from S3`);
    } catch (error) {
        console.error('Error clearing data from S3:', error);
        throw error;
    }
};
...
module.exports = { addComment, getAllExceedData, editComments, getAUserExceedData, handleExceedValues,getExceedDataByUserName,fetchAndDeleteDataByUserName , clearDataFromS3 }