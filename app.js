...
// Middleware
app.use(cors({
    origin: ['http://localhost:3000',  'http://localhost:3001','https://ems.ebhoom.com','http://ems.ebhoom.com','https://ocems.ebhoom.com','https://api.ocems.ebhoom.com','http://localhost:3001'],
    credentials: true,
